export default {
    route: {
        ...
        wareHousesView: 'View',
        wareHousesRelation: 'WareHousesRelation',
        sizeGroup: 'SizeGroup',
        sizeRules: 'SizeRules',
        categoryStandards: 'CategoryStandards',
        ...
        goodsSizeGroup: 'GoodsSizeGroup',
        distributionManage: 'DistributionManage',
        distributionGroups: 'DistributionGroups',
        distributionItems: 'DistributionItems',
        distributionItemsAdd: 'Add',
        distributionItemsEdit: 'Edit',
        distributionItemsView: 'View',
        storeGroupStructure: 'StoreGroupStructure',
        singleRelationship: 'SingleRelationship',
        storeStructure: 'StoreStructure',
        saleCarStructure: 'SaleCarStructure',
        storeStandard: 'StoreStandard',
        multipleRelationship: 'MultipleRelationship',
        baseDataCenter: 'BaseDataCenter',
        ...
        stylesColorsData: 'StylesColorsData',
        sizesData: 'SizesData',
        rulesCenter: 'RulesCenter',
        systemAlgorithm: 'SystemAlgorithm',
